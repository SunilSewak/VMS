  ...
  demoSet(DEMO_COLLECTIONS.MEETINGS, [
    {
      ...
      transfer_requirements: 'Airport pickup for 40 delegates', status: 'SUBMITTED_TO_ADMIN',
    ...
    },
    {
      ...
      transfer_requirements: 'Coach transfers from 3 airports', status: 'VENUES_SHORTLISTED',
    ...
    },
    {
      ...
      transfer_requirements: 'None', status: 'AVAILABILITY_CHECK',
